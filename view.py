...
██║  ██╗███████╗██║ ╚████║    ██║ ╚═╝ ██║██║  ██║╚██████╔╝██║╚██████╗
╚═╝  ╚═╝╚══════╝╚═╝  ╚═══╝    ╚═╝     ╚═╝╚═╝  ╚═╝ ╚═════╝ ╚═╝ ╚═════╝                                                                                                                                        
{trang}           </> ANH EM ĐĂNG KÝ KÊNH KEN MAGIC OF PHẠM VIỆT TÂY NHÉ </>
\033[1;37m────────────────────────────────────────────────────────────
{do}[{trang}{kt_code}{do}] {vang}VIEW TIK TOK V2 MAX SPEED 
{do}[{trang}{kt_code}{do}] \033[1;35mADMIN:\033[1;36m KEN MAGIC
{do}[{trang}{kt_code}{do}] \033[1;31mZALO: \033[1;33m 84349240085
{do}[{trang}{kt_code}{do}] {dac_biet}YOUTUBE:\033[1;37m KEN MAGIC
\033[1;37m────────────────────────────────────────────────────────────"""
        ...
        try:
            ...
            try:
                if response.json()['status_code'] == 0:
                    _lock.acquire()
                    print(f'{do}[{vang}SubSaleF5{do}] {do}[{xanh_la}BUFF VIEW SUCCESS{do}] {do}{xanh_duong}+: {trang}{success}{do} View')
                    success += 1
                    _lock.release()
            except:
